...
| Phase 3 | 基于 manager 的企业产品界面，包括 Web Console、tenant、workspace、可视化编排、发布流程、evaluation UX 和 provider 管理。 | **已完成。** Manager API CRUD、CRD 同步、Agent/Evaluation/Run/Provider 详情页、可视化编排工作台（6 种模式）。 |
