...
func (NoopCRDSyncer) DeleteWorkspace(_ context.Context, _ WorkspaceRecord) error { return nil }
func (NoopCRDSyncer) SyncAgent(_ context.Context, _ AgentRecord) error           { return nil }
func (NoopCRDSyncer) DeleteAgent(_ context.Context, _ AgentRecord) error         { return nil }
func (NoopCRDSyncer) SyncEvaluation(_ context.Context, _ EvaluationRecord) error { return nil }
func (NoopCRDSyncer) DeleteEvaluation(_ context.Context, _ EvaluationRecord) error {
	return nil
}
func (NoopCRDSyncer) SyncProvider(_ context.Context, _ ProviderRecord) error   { return nil }
func (NoopCRDSyncer) DeleteProvider(_ context.Context, _ ProviderRecord) error { return nil }
